...
$functions = @("external-bets", "user-statistics", "sync-events", "get-events", "generate-predictions", "auto-sync", "get-predictions", "cleanup-predictions")
...
Write-Host "  - Auto Sync: https://$projectRef.supabase.co/functions/v1/auto-sync" -ForegroundColor White
