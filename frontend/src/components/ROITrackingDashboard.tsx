...
export default function ROITrackingDashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className={`bg-gradient-to-br rounded-xl p-8 border-2 relative overflow-hidden ${
        tracking.totalROI >= 0
        ...
        <div className="text-center relative z-10">
          <p className="text-sm text-gray-300 mb-2">ROI Total desde que usas BETAPREDIT</p>
          <h2 className={`text-6xl font-black mb-2 animate-pulse ${
      ...
      {tracking.comparison && (
        <div className="bg-gradient-to-br from-primary-500/20 to-accent-500/20 rounded-xl p-6 border border-primary-500/40">
          <h3 className="text-xl font-black text-white mb-4">Comparación</h3>
          <div className="grid grid-cols-2 gap-4">
            <div className="text-center">
              <p className="text-sm text-gray-400 mb-1">Sin BETAPREDIT</p>
            ...
            <div className="text-center">
              <p className="text-sm text-gray-400 mb-1">Con BETAPREDIT</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-gradient-to-br from-dark-900 to-dark-950 rounded-xl p-6 border border-primary-500/20">
          <p className="text-sm text-gray-400 mb-2">Total Apostado</p>
          <p className="text-2xl font-black text-white">€{tracking.totalStaked.toLocaleString()}</p>
          <p className="text-xs text-gray-500 mt-1">{tracking.totalBets} apuestas</p>
        </div>
        <div className="bg-gradient-to-br from-dark-900 to-dark-950 rounded-xl p-6 border border-primary-500/20">
          <p className="text-sm text-gray-400 mb-2">Total Ganado</p>
          <p className="text-2xl font-black text-green-400">€{tracking.totalWon.toLocaleString()}</p>
          <p className="text-xs text-gray-500 mt-1">{tracking.totalWins} ganadas</p>
        </div>
        <div className="bg-gradient-to-br from-dark-900 to-dark-950 rounded-xl p-6 border border-primary-500/20">
          <p className="text-sm text-gray-400 mb-2">Win Rate</p>
          <p className="text-2xl font-black text-white">{tracking.totalBets > 0 
      ...
      {tracking.valueBetsMetrics.taken > 0 && (
        <div className="bg-gradient-to-br from-gold-500/20 to-accent-500/20 rounded-xl p-6 border border-gold-500/40">
          <h3 className="text-xl font-black text-white mb-4">Value Bets</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div>
              <p className="text-sm text-gray-400 mb-1">Tomados</p>
              <p className="text-2xl font-black text-white">{tracking.valueBetsMetrics.taken}</p>
            </div>
            <div>
              <p className="text-sm text-gray-400 mb-1">Ganados</p>
              <p className="text-2xl font-black text-green-400">{tracking.valueBetsMetrics.won}</p>
            </div>
            <div>
              <p className="text-sm text-gray-400 mb-1">Win Rate</p>
              <p className="text-2xl font-black text-white">{tracking.valueBetsMetrics.winRate.toFixed(1)}%</p>
            </div>
            <div>
      ...
      {chartData.length > 0 && (
        <div className="bg-gradient-to-br from-dark-900 to-dark-950 rounded-xl p-6 border border-primary-500/20">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-xl font-black text-white">Evolución de ROI</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-gradient-to-br from-dark-900 to-dark-950 rounded-xl p-6 border border-primary-500/20">
          <h3 className="text-lg font-black text-white mb-4">Value Bets</h3>
          <div className="space-y-2">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-white font-semibold">{tracking.valueBetsMetrics.taken}</span>
            </div>
            <div className="flex justify-between">
        ...
        <div className="bg-gradient-to-br from-dark-900 to-dark-950 rounded-xl p-6 border border-primary-500/20">
          <h3 className="text-lg font-black text-white mb-4">Apuestas Normales</h3>
          <div className="space-y-2">
            <div className="flex justify-between">
              <span className="text-gray-400">ROI</span>
              <span className={`font-bold ${
