...
export default function Predictions() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="relative max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-3 sm:py-4 md:py-6 z-10">
        ...
        {!isLoading && (
          <>
            {viewMode === 'grid' ? (
              // Grid View - Más compacto
              <div className="space-y-4 sm:space-y-6">
                {sortedEvents.map((event: EventPrediction) => (
                  <div
                    key={event.eventId}
                    className="bg-gradient-to-br from-slate-800/90 via-slate-800/80 to-slate-900/90 backdrop-blur-xl rounded-2xl border-2 border-slate-700/50 overflow-hidden shadow-xl hover:shadow-primary-500/20 hover:border-primary-500/30 transition-all duration-300 hover:scale-[1.01] group"
                  >
                    {/* Event Header - Más compacto */}
                    <div className="bg-gradient-to-r from-slate-800/90 via-slate-900/90 to-slate-800/90 px-3 sm:px-4 py-3 sm:py-4 border-b-2 border-slate-700/50 backdrop-blur-sm relative overflow-hidden">
                      ...
                      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 sm:gap-4">
                        <div className="flex-1 min-w-0">
                          <div className="flex flex-col sm:flex-row sm:items-center gap-1.5 sm:gap-2 mb-2">
                            <span className="px-2 py-1 bg-primary-500/20 text-primary-300 rounded-lg text-[10px] sm:text-xs font-black border border-primary-500/40 w-fit">
                              {event.sport}
                            </span>
                            <h3 className="text-base sm:text-lg md:text-xl font-black text-white break-words leading-tight">
                    ...
                    {/* Predictions Grid - Más compacto */}
                    <div className="p-3 sm:p-4">
                      <div className="mb-3 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            <div className="w-6 h-6 rounded-lg bg-gradient-to-br from-primary-500/20 to-accent-500/20 flex items-center justify-center border border-primary-500/30">
                              <Icon name="chart" size={12} className="text-primary-300" />
                            </div>
                            <h4 className="text-sm sm:text-base font-black text-white">
                              Mercado de Predicciones
                            </h4>
                          </div>
                          <p className="text-[10px] sm:text-xs text-gray-400 ml-0 sm:ml-8">
                        ...
                        <div className="flex items-center gap-1.5 text-[10px] bg-gradient-to-r from-green-500/10 to-emerald-500/10 px-2.5 py-1 rounded-full border border-green-500/30 shadow-md">
